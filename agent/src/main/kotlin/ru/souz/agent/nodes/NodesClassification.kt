...
"""
    ...
    private fun ToolCategory.description(): String = when (this) {
        ...
        SHELL -> "выполнение POSIX shell команд внутри sandbox окружения приложения"
    ...
    private fun ToolCategory.examples(): List<String> = when (this) {
        ...
        SHELL -> listOf(
            "выполни команду pwd в Android sandbox",
            "запусти shell команду ls -la в домашней папке sandbox",
        )
