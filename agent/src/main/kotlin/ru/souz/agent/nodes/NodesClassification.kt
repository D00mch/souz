...
7. Для IMAGE учитывай полную цепочку: если нужно сначала сделать скриншот, а потом понять, что на нем, всё равно выбирай IMAGE.
...
"""
    ...
    private fun ToolCategory.description(): String = when (this) {
        ...
        IMAGE -> "работа со скриншотами, локальными изображениями, их анализом и генерацией изображений"
