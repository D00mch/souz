...
7. Если нужно сначала сделать скриншот, а потом понять, что на нем, выбирай и DESKTOP, и IMAGE.
...
"""
    ...
    private fun ToolCategory.description(): String = when (this) {
        ...
        IMAGE -> "анализ локальных изображений и содержимого скриншотов после захвата"
        ...
        DESKTOP -> "захват экрана: скриншоты и запись видео с экрана"
