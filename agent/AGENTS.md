...
- Agent settings carry an explicit provider and host-resolved model ID. Update them together when selecting a model and preserve them through child requests.
