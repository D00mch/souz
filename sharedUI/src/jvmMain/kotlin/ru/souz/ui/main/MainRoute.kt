...
fun MainScreen(
    ...
    MainScreenContent(
        ...
        onUpdateChatInputText = { text, localEditRevision ->
            viewModel.send(MainEvent.UpdateChatInputText(text, localEditRevision))
        },
        onSendChatMessage = { text -> viewModel.send(MainEvent.SendChatMessage(text)) },
