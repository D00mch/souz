...
- PostgreSQL stores structured repositories and conversation Knowledge. Knowledge must not resolve a filesystem sandbox; its writer and retrieval tools share the backend store. Sandbox workspaces remain filesystem-backed and user-scoped.
