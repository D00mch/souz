...
- Restrict compiled direct tools with the trusted user's effective `enabledTools` snapshot for category selection and invocation. Add built-in client operations only to Client-Souz executions.
