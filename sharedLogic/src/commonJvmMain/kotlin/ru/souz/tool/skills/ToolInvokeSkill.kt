...
class ToolInvokeSkill(
    ...
    /** Tools a composite `tool:` step may call: the caller's own dispatch table, union with
     * whatever compiled tools [resolver] could already reach via a plain `RunSkillCommand`. */
