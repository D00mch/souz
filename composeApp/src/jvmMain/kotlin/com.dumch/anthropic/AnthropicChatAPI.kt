        ...
        val messages = body.messages
            ...
            .map { msg ->
                ...
                msg.attachments?.forEach { id ->
                    ...
                    val blockType = if (mime.startsWith("composeApp/src/jvmMain/kotlin/com.dumch/image/")) "composeApp/src/jvmMain/kotlin/com.dumch/imageseApp/src/jvmMain/kotlin/com.dumch/image" else "document"
                    content += mapOf(
                        "type" to blockType,
                        "source" to mapOf(
                            "type" to "file",
