...
class ToolTelegramGetHistory(
    ...
    data class Input(
        ...
        val chatName: String,
        @InputParamDescription("How many recent messages to return. Use 100 by default for reading a chat unless user asked for another count.")
        val limit: Int = 100,
    ...
    override val description: String = "Gets Telegram chat history for a selected chat. By default it force-loads and caches the latest 100 messages."
