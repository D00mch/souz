...
suspend fun formatChatAgentAction(functionCall: GigaResponse.FunctionCall): String {
    ...
    return when (functionCall.name) {
        ...
        "ExtractTextFromFile" -> format(Res.string.chat_action_extract_text_from_file, pathArg(args, "path"))
        "FindFilesByName" -> format(Res.string.chat_action_find_files_by_name, textArg(args, "fileName"))
        "ReadPdfPages" -> format(Res.string.chat_action_read_pdf_pages, pathArg(args, "path"))
