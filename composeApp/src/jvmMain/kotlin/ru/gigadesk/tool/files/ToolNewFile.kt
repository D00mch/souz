...
class ToolNewFile(private val filesToolUtil: FilesToolUtil) : ToolSetup<ToolNewFile.Input> {
    ...
    override val description = "Creates a new TEXT file at the given path with the provided content. forbidden: .xlsx, .xls, .png, .jpg, .pdf. For Excel, use ExcelWrite/ExcelTransform."
