...
class NodesClassification(
    ...
    private fun ToolCategory.description(): String = when (this) {
        ToolCategory.FILES -> """
навигация по файловой системе, чтение и поиск текста в файлах, создание, удаление или изменение файлов"""
...
манипуляции с рабочим столом, окнами и экранами, открытие и использование приложений, работа с заметками, 
...
получение и отправка писем, список писем, чтение писем, ответ на письмо, прочтение сообщений из почты"""
    ...
    private fun ToolCategory.examples(): List<String> = when (this) {
        ...
        ToolCategory.DESKTOP -> listOf(
            ...
            "найди и открой приложение Intellij IDEA",
            "сверни все окна",
            "перемести текущее окно на второй монитор"
        )
