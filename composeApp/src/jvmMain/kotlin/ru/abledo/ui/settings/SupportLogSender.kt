...
class SupportLogSender(
    ...
    private fun defaultLogDir(): String {
        ...
        return Paths.get(home, ".local", "state", "abledo", "logs").toString()
    }

    private fun zipLogs(logs: List<Path>): Path {
        val tmp = Files.createTempFile("abledo-logs-${Instant.now().epochSecond}", ".zip")
    ...
    companion object {
        ...
        private const val SUPPORT_EMAIL_SUBJECT = "Логи Abledo"
