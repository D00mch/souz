        ...
        val messages = body.messages
            ...
            .map { msg ->
                ...
                msg.attachments?.forEach { id ->
                    ...
                    val blockType = if (mime.startsWith("composeApp/src/jvmMain/kotlin/ru.abledo/image/")) "composeApp/src/jvmMain/kotlin/ru.abledo/imageseApp/src/jvmMain/kotlin/ru.abledo/image" else "document"
                    content += mapOf(
                        "type" to blockType,
                        "source" to mapOf(
                            "type" to "file",
