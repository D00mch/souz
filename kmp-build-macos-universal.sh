...
JDK_ARM64="${JDK_ARM64:-/Library/Java/JavaVirtualMachines/temurin-21.jdk/Contents/Home}"

JDK_X64="${JDK_X64:-$(read_property 'macos.jdk.x64' "$LOCAL_PROPERTIES")}"
JDK_X64="${JDK_X64:-/Library/Java/JavaVirtualMachines/zulu-21.jdk/Contents/Home}"
