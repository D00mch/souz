    ...
    companion object {
        ...
        private val systemPrompt = GigaRequest.Message(
            ...
            content = """
                ...
                Если тебя просят открыть какой-то сайт, а браузер(например, Safari) уже запущен - открой новую вкладку в том же окне через функцию toolCreateNewBrowserTab. 
                ...
                Если тебя просят нажать на какую-либо область на экране, используй функцию DesktopScreenShot, определяй координаты и нажимай на подходящую область используя функцию MouseClick.
            """.trimIndent()
        )
